...
\subsection{Gravitational Waves and GRB 170817A} \label{sec:gw170817} 
...
\end{center}
\caption{\textbf{Brightness/Luminonsity against redshift}  \textbf{cite GRB BNS paper} }
...
\end{center}
\caption{\textbf{Jet Structure Scenarios.} \textbf{cite GRB BNS paper} }
\label{fig:jet}
\end{figure}
