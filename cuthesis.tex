...
\subsection{Late Time Afterglow Observations}
...
\begin{itemize}
\item GRB was very faint - requires explanation
\item Structured jet/top hat
\item For a structured jet it is expected that the afterglow will slowly get brighter as more light from the jet reaches us, a viewer at a large angle from the axis
\item MCMC analysis with different models strongly favours structured jet with or without cocoon
\end{itemize}
...
\end{center}
\caption{\textbf{Structured Jet.}  \textbf{cite GRB afterglow paper paper} }
