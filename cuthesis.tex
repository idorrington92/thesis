...
\chapter{The Future of PyGRB} \label{sec:pygrb improvements}
...
\end{center}
\caption{\textbf{Coherent SNR vs Time.} 170817 run. } 
...
\end{center}
\caption{\textbf{Null SNR vs Time.} 170817 run. } 
...
\end{center}
\caption{\textbf{Reweighted SNR vs Time.} 170817 run. Black line is cut.} 
...
\end{center}
\caption{\textbf{Highest Coherent SNR Event in Off-source Trials.} 170817 run. Star is BNS.} 
...
\end{center}
\caption{\textbf{Loudest Event in Off-source Trials.} 170817 run. Star is BNS.} 
...
\end{center}
\caption{\textbf{Injection Distance against Time.} PyGRB O2 run of 170817.} 
...
\end{center}
\caption{\textbf{Injection Distance against Chirp Mass.} O2 PyGRB 170817 run} 
\label{fig:old inj dist mchirp}
\end{figure}

\begin{itemize}
\item \textbf{MUST REGENRATE ALL PLOTS IN THIS SECTION}
\item An analysis with more injections is running now
