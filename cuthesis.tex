...
\end{equation}
where $f_\text{peak}$ is the peak frequency of the waveform, measured in Hertz. This formula is the same as the current PyCBC analysis, and was determined empirically. \cite{GW150914_searches}
